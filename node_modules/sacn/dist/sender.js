...
var _Sender_loopId, _Sender_latestPacketOptions;
...
class Sender {
    constructor({ universe, port = 5568, reuseAddr = false, minRefreshRate = 0, defaultPacketOptions, }) {
        this.sequence = 0;
        ...
        this.multicastDest = (0, util_1.multicastGroup)(universe);
...
_Sender_loopId = new WeakMap(), _Sender_latestPacketOptions = new WeakMap();
